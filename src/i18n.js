...
export const translations = {
  en: {
    ...
    payouts: {
      ...
      sessions:             'Sessions',
      month:                'Month',
      settlePayout:         'Mark settled',
      alreadyPaid:          'Already Paid',
      export:               'Export Report',
      therapistPayoutsTitle:'Therapist payouts',
    ...
    settings: {
      ...
      categoriesDesc:    'Manage expense categories and sub-categories used in forms.',
      addCategory:       'Add category',
      addSubCategory:    'Add sub-category',
      categoryPlaceholder:'Category name',
      subCategoryPlaceholder: 'Sub-category name',
      noCategories:      'No categories yet. Add one above.',
      deleteCategoryConfirm: 'Delete this category and all its sub-categories?',
    },
  ...
  ar: {
    ...
    payouts: {
      ...
      therapistPayoutsTitle:'مستحقات المعالجين',
      centerRevenue:        'إيرادات المركز',
      share:                'حصة',
      seeSessions:          'عرض الجلسات',
      hideSessions:         'إخفاء',
      settled:              'تمت التسوية',
      colDate:              'التاريخ',
      colClient:            'العميل',
    ...
    settings: {
      ...
      categories:        'الفئات',
      categoriesDesc:    'إدارة فئات ومصروفات الفئات الفرعية المستخدمة في النماذج.',
      addCategory:       'إضافة فئة',
      addSubCategory:    'إضافة فئة فرعية',
      categoryPlaceholder:'اسم الفئة',
      subCategoryPlaceholder: 'اسم الفئة الفرعية',
      noCategories:      'لا توجد فئات بعد. أضف فئة أعلاه.',
      deleteCategoryConfirm: 'حذف هذه الفئة وجميع فئاتها الفرعية؟',
    },
